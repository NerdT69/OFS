...
Please pick the correct video.)",
	...
	R"(Quick export (2.0))",
	R"(Exports combined 2.0 funscript with channels.)",
	R"(Quick export (1.1))",
	R"(Exports combined 1.1 funscript with axes.)",
...
Frame limit is ignored.)",
	...
	R"(Pattern name)",
	R"(Column)",
	R"(No funscript selected)",
	R"(Cancel)",
	R"(Rename pattern)",
	R"(Set hotkey)",
	R"(Clear hotkey)",
	R"(+ Selection)",
	R"(No selection to create pattern from)",
...
std::unordered_map<std::string, Tr> OFS_DefaultStrings::KeyMapping =
{
	...
	{"ACTION_QUICK_EXPORT_2_0", Tr::ACTION_QUICK_EXPORT_2_0},
	...
	{"QUICK_EXPORT_2_0", Tr::QUICK_EXPORT_2_0},
	{"QUICK_EXPORT_2_0_TOOLTIP", Tr::QUICK_EXPORT_2_0_TOOLTIP},
	{"QUICK_EXPORT_1_1", Tr::QUICK_EXPORT_1_1},
	{"QUICK_EXPORT_1_1_TOOLTIP", Tr::QUICK_EXPORT_1_1_TOOLTIP},
	...
	{"LOAD_TEMPLATE", Tr::LOAD_TEMPLATE},
	...
	{"ADD_PATTERN", Tr::ADD_PATTERN},
	{"SELECT_FUNSCRIPT", Tr::SELECT_FUNSCRIPT},
	{"MOVE_TO_COLUMN", Tr::MOVE_TO_COLUMN},
	{"BROWSE", Tr::BROWSE},
	{"EDIT_PATTERN", Tr::EDIT_PATTERN},
	{"DELETE_PATTERN", Tr::DELETE_PATTERN},
	{"PATTERN_NAME", Tr::PATTERN_NAME},
	{"COLUMN", Tr::COLUMN},
	{"NO_FUNSCRIPT_SELECTED", Tr::NO_FUNSCRIPT_SELECTED},
	{"CANCEL", Tr::CANCEL},
	{"RENAME_PATTERN", Tr::RENAME_PATTERN},
	{"SET_HOTKEY", Tr::SET_HOTKEY},
	{"CLEAR_HOTKEY", Tr::CLEAR_HOTKEY},
	{"CREATE_FROM_SELECTION", Tr::CREATE_FROM_SELECTION},
	{"SELECTION_EMPTY", Tr::SELECTION_EMPTY},
