...
private:
    ...
    void addEditAction(int positionValue) noexcept;
...
public:
    ...
    std::unique_ptr<PatternPicker> patternPicker;
    std::unique_ptr<OFS_DeviceManager> deviceMgr;
    std::unique_ptr<DevicePanel> devicePanel;
    std::unique_ptr<OFS_VoiceInput> voiceInput;
